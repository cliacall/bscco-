...
[观看 3 分钟内中文讲解 Demo](zai/docs/demo_video/bscco_demo_zh.mp4)

字幕与旁白稿：

- [中文字幕 SRT](zai/docs/demo_video/bscco_demo_zh.srt)
- [中文旁白稿](zai/docs/demo_video/bscco_demo_narration.txt)
